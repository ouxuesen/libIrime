...
class DefaultSettings: ExtraView, UITableViewDataSource, UITableViewDelegate {
    ...
    func loadNib() {
        ...
        if assets!.count > 0 {
            if let rootView = assets!.first as? UIView {
                ...
                let top = NSLayoutConstraint(item: rootView, attribute: .top, relatedBy: .equal, toItem: self, attribute: NSLayoutConstraint.Attribute.top, multiplier: 1, constant: 0)
    ...
    func updateAppearance(_ dark: Bool) {
        if dark {
            ...
            self.backButton?.setTitleColor(blueColor, for: UIControl.State.normal)
...
class DefaultSettingsTableViewCell: UITableViewCell {
    ...
    func addConstraints() {
        ...
        if hasLongText {
            ...
            let switchTop = NSLayoutConstraint(item: sw, attribute: .top, relatedBy: .equal, toItem: self, attribute: NSLayoutConstraint.Attribute.top, multiplier: 1, constant: margin)
            ...
            let labelCenter = NSLayoutConstraint(item: label, attribute: .centerY, relatedBy: NSLayoutConstraint.Relation.equal, toItem: sw, attribute: .centerY, multiplier: 1, constant: 0)
            ...
            let bottom = NSLayoutConstraint(item: longLabel, attribute: .bottom, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self, attribute: NSLayoutConstraint.Attribute.bottom, multiplier: 1, constant: -margin)
