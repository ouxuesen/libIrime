...
//        collectionView.backgroundColor = UIColor.blueColor()
        ...
        moreCandidatesButton = UIButton.init(type: .custom)
...
//        preeLable.backgroundColor = UIColor.brownColor()
     ...
     func updateAppearance() {
        ...
        moreCandidatesButton.setImage(candidatesBannerAppearanceIsDark ? UIImage(named: "arrow-down-white") : UIImage(named: "arrow-down-black"), for: .normal)
    ...
    func changeArrowUp() {
        moreCandidatesButton.setImage(candidatesBannerAppearanceIsDark ? UIImage(named: "arrow-up-white") : UIImage(named: "arrow-up-black"), for: .normal)
    }
