...
//                            let cancelEvents: UIControlEvents = [UIControlEvents.TouchUpInside, UIControlEvents.TouchUpInside, UIControlEvents.TouchDragExit, UIControlEvents.TouchUpOutside, UIControlEvents.TouchCancel, UIControlEvents.TouchDragOutside]
                        ...
                        if key.isCharacter {
                            if UIDevice.current.userInterfaceIdiom != UIUserInterfaceIdiom.pad {
                                ...
                                keyView.addTarget(self, action: #selector(hidePopup(_:)), for: [.touchDragExit, .touchCancel])
...
//        self.textDocumentProxy.deleteBackward()
    ...
    @objc func spaceUpInside(_ sender: KeyboardKey, withEvent event:UIEvent) {
        
        spaceDragPoint = CGPoint(x: 0, y: 0)
    }
    @objc func spaceDown(_ sender: KeyboardKey, withEvent event:UIEvent) {
    ...
    @objc func spaceDragInside(_ sender: KeyboardKey,  withEvent event:UIEvent) {
